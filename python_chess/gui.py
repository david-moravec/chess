...
class GameBoard(tk.Frame):
    ...
    def addpiece(self, row=0, column=0):
        '''Add a piece to the playing board'''
        self.canvas.create_image(0,0, image=imagedate, tags=(name, "piece"), anchor="c")
